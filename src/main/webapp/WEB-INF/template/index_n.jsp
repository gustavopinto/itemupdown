				...
				<div class="menu clearfix">
					...
					<ul id="pgmenu">
						...
						<li><a href="#">Help</a></li>
						 ...
						 <li><a href="javascript:showLog();">查看上下架日志</a></li>
								...
								<table cellpadding="0" cellspacing="0" border="0" id="table" class="uiTable"> 
									...
									<tbody> 
									   <c:forEach var="task" items="${taskList}">
											<tr>
												<td>${task.taskName}</td>
												<td><c:if test="${task.kind==1}">上架</c:if> <c:if
														test="${task.kind==2}">下架</c:if></td>
	...
	<script type="text/javascript">
		...
		function modifyTask(taskId) {
			$.dialog({
				...
				width : 400,
				height : 300,
				content : 'url:/task/delTask.htm?taskId=' + taskId
		      });
                }
		...
		function showLog(){
			$.dialog({
                ...
                $.dialog.notice({
                     ...
                     content: '<p>1.宝贝助手国庆大促销，每月只需要2元</p>',
                     time: 5
                });
	</script>
