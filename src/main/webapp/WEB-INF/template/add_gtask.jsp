	...
	<div class="content-box">
		...
		<div class="content-box-content">
			...
			<div id="tab2" class="tab-content" style="display: block;">
				...
				<form method="post" action="/task/addGtask.htm" id="addTaskForm">
					...
					<fieldset>
                        ...
                        <p>
                            <label>任务类型：</label> <select class="small-input" name="kind"
								...
								<option value="1">橱窗推荐</option>
								<option value="2">取消橱窗推荐</option>
...
<script type="text/javascript">	
	...
	function searchItem(){
		$.dialog({
            width: 960,
            height:700,
			content: 'url:/item/prepareSearchItem.htm?gtask=1',
		});
	}
