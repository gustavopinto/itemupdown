	...
	<div class="content-box">
		...
		<div class="content-box-content">
			...
			<div id="tab2" class="tab-content" style="display: block;">
				...
				<form method="post" action="/task/modifyTask.htm" id="modifyTaskForm">
					...
					<fieldset>
                        ...
                        <p>
                            <label>任务类型：</label> <select class="small-input" name="kind"
								...
								<option value="1" <c:if test="${task.kind == 1}">selected="selected"</c:if> >上架</option>
								<option value="2" <c:if test="${task.kind == 2}">selected="selected"</c:if> >下架</option>
...
function searchItem(){
	...
	$.dialog({
        width: 960,
        height:700,
		content: 'url:/item/prepareSearchItem.htm?selectItems='+selectItems
	});
}
